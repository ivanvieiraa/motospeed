                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="capacetes.php">Capacetes</a></li>
                        </ol>
                    </nav>
                    <h1 class="fw-bold fs-3 mb-2">Capacetes
                        (<?php
                        include('ligacao.php');

                        $sql = "SELECT COUNT(*) as produtos, c.nome_categoria
                                FROM produtos p
                                INNER JOIN categorias c ON p.id_categoria = c.id_categoria
                                WHERE status =1 AND c.nome_categoria = 'Capacetes'";
