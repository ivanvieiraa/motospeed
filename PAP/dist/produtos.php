            ...
            <nav>
                <ul class="pagination justify-content-center">
                    ...
                    for ($pagina = 1; $pagina <= $total_paginas; $pagina++) {
                        ...
                        echo '<li class="page-item ' . $classe_ativa . '"><a class="page-link" href="' . construirURL($pagina) . '">' . $pagina . '</a></li>';
                    }
                    ?>
                </ul>
            </nav>
                ...
                <div class="d-flex flex-column justify-content-between w-100 h-100">
                                            ...
                                            while ($rowMarcas = mysqli_fetch_assoc($resultMarcas)) {
                                                ...
                                                <div class="form-group form-check-custom mb-1">
                                                    <input type="checkbox" class="form-check-input marca-checkbox"
                                                        id="marca_<?php echo $rowMarcas['id_marca']; ?>"
                                                        value="<?php echo $rowMarcas['id_marca']; ?>" name="marca"
                                                        onclick="selecionarMarca(this)" <?php if (isset($_GET['id_marca']) && $_GET['id_marca'] == $rowMarcas['id_marca'])
                                                            echo 'checked'; ?>>
                                                    <label
                                            ...
                                            while ($rowCategorias = mysqli_fetch_assoc($resultCategorias)) {
                                                ...
                                                <div class="form-group form-check-custom mb-1">
                                                    <input type="checkbox" class="form-check-input categoria-checkbox"
                                                        ...
                                                        value="<?php echo $rowCategorias['id_categoria']; ?>" name="categoria"
                                                        onclick="selecionarCategoria(this)" <?php if (isset($_GET['id_categoria']) && $_GET['id_categoria'] == $rowCategorias['id_categoria'])
                                                            echo 'checked'; ?>>
                                                    <label
                                                        class="form-check-label fw-normal text-body flex-grow-1 d-flex align-items-center"
                                                ...
                                                <script>
                                                    function selecionarCategoria(selecionada) {
                    ...
                    <div class="border-top pt-3">
                        <a href="#" class="btn btn-dark mt-2 d-block hover-lift-sm hover-boxshadow"
                            data-bs-dismiss="offcanvas" aria-label="Close">Aplicar filtros</a>
                    </div>
                    <!-- /Filter Button-->
                </div>
            </div>
