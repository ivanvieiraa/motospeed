...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Verifique se já existe um produto com o mesmo nome (exceto o atual)
    $sql_verifica = "SELECT * FROM produtos WHERE nome_prod = '$nome_prod' AND id_prod != '$id_prod'";
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        if (mysqli_query($con, $sql)) {
            ...
            $_SESSION['mensagem'] = "Erro ao atualizar produto: " . mysqli_error($con);
        }
    }
