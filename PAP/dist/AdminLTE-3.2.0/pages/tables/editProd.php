          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <form action="updateProduto.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <input placeholder="Preço" step="any" type="number" max="3000" min="0" name="preco_prod" id="preco_prod" value="<?php echo $row['preco_prod']; ?>" oninput="clearErrorMessage('preco-prod-error', this)">
